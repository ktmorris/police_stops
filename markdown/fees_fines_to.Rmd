...
p5 <- readRDS("./temp/simple_scat_gap_bw.rds")
load("./temp/mef_gap_bw.rdata")
print(p5)
print(p6)
```
...
That the racial turnout gap is smaller in cities with more fees and fines is surprising, and the opposite of what we expected to find. This could reflect racially disparate policing in cities with low fee collection. It is possible that cities with *low* fees and fines collections disproportionately penalize nonwhite residents; as fees and fines collections increase, however, a larger share of the population --- and, thus, more white voters --- may have a negative interaction with a police officer, thereby *reducing* racial disparities and consequently discrepancies in the racial turnout gap.
