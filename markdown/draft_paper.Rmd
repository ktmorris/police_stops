...
j <- knitr::kable(t, booktabs = T, caption = "(\\#tab:lit-table) Summary of Literature", linesep = "",
                  align = c("l", "l", "l"), "latex") %>%
