...
matches <- readRDS("temp/full_reg_data_no_prior.rds")
...
for(gg in c("overall", "2014-11-04", "2016-11-08", "2018-11-06")){
  ...
  saveRDS(c, paste0("temp/cints_full_", gg, "_no_prior.rds"))
}

cleanup()

cints <- rbindlist(lapply(c("overall", "2014-11-04", "2016-11-08", "2018-11-06"), function(gg){
  readRDS(paste0("temp/cints_full_", gg, "_no_prior.rds"))
})) %>% 
...
p
saveRDS(p, "temp/coef_plot_no_prior.rds")
...
p
saveRDS(p, "temp/event_study_no_prior.rds")
