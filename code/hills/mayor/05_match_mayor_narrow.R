...
hills15_t <- filter(hills_pre_match, first_tr_year == "2015-03-03",
                    last_date >= "2015-01-03",
                    last_date <= "2015-05-03") %>% 
...
hills19_t <- filter(hills_pre_match, first_tr_year == "2019-03-05",
                    last_date >= "2019-01-05",
                    last_date <= "2019-05-05") %>% 
...
saveRDS(pre, "temp/real_pre_match_hills_mayor_narrow.rds")
...
save(mout, file = "./temp/mout_hills_y_mayor_narrow.RData")

load("temp/mout_hills_y_mayor_narrow.RData")
...
saveRDS(matches, "temp/matches_hills_y_mayor_narrow.rds")
