...
#############################
v2020 <- fread("E:/rolls/florida/FL 2021-03-09/FL 2021-03-09/20210309_VoterDetail/HIL_20210309.txt")
colnames(v2020) <- vf_names
v2020 <- select(v2020,
                voter_id,
                name_last,
                name_first,
                ...
                registration_date) %>% 
  mutate(latest_mayor = T)
roll <- bind_rows(roll, filter(v2020, !(voter_id %in% roll$voter_id)))
rm(v2012, v2014, v2016, v2018, v2019, v2020)
##################################################
hists <- rbindlist(lapply(c("E:/rolls/florida/FL-2013-1/VoterHistory_20130203/HIL_H_20130203-ReSave.txt",
                            ...
                            "E:/rolls/florida/FL 2021-03-09/FL 2021-03-09/20210309_VoterHistory/HIL_H_20210309.txt"),
                          fread))
...
roll$v20 <- roll$voter_id %in% filter(hists, V3 =="11/03/2020")$V2
