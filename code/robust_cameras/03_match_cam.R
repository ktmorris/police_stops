...
genout <- readRDS("temp/genout_hills_cam.rds")
...
save(mout, file = "./temp/mout_hills_cam.RData")

load("temp/mout_hills_cam.RData")
...
saveRDS(matches, "temp/matches_hills_cam.rds")
